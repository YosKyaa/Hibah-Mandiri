...
@section('content')
    ...
    <div class="nav-align-top mb-4">
        <ul class="nav nav-tabs nav-fill" role="tablist">
            ...
            <li class="nav-item">
                <a type="button" class="nav-link active" data-bs-target="#fund-disbursement-2"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $('#datatable').DataTable({
                ...
                ajax: {
                    url: "{{ route('fund-disbursement-2.data') }}",
                    data: function(d) {
                    ...
                    },
                    {
                        render: function(data, type, row, meta) {
                            ...
                            if (row.documents && row.documents.some(doc => doc
                                    .doc_type_id ===
                                    'DC6' || row.status_id === 'S08' || row.status_id === 'S09')) {
                                html =
                                ...
                                <a class="badge badge-center rounded-pill bg-info" title="Unggah Bukti Tahap 1" href="{{ url('admin/fund-disbursement-2/transfer_receipt/${row.id}') }}"><i class="bx bx-upload" style="color:#ffff"></i></a>`;
