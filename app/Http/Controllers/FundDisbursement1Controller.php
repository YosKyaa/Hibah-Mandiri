...
class FundDisbursement1Controller extends Controller
{
    public function index()
    {
        ...
        return view('admin.fund-disbursement-1.index', compact( 'totalUsers', 'proposalCount', 'totalNullReviewers', 'proposalApproved', 'proposalDisapprove'));
    }
    ...
    public function transfer_receipt($id)
    {
        try {
            ...
            return view('admin.fund-disbursement-1.transfer_receipt', compact('proposals', 'documentUrl', 'documentPath'));
        } catch (\Exception $e) {
            return redirect()->route('fund-disbursement-1.index')->with('error', 'Failed to generate transfer receipt: ' . $e->getMessage());
        }
    }
    ...
    public function transfer_receipt_update(Request $request, $id)
    {
        try {
            ...
            return redirect()->route('fund-disbursement-1.index')->with('success', 'Data berhasil diperbarui.');
        } catch (\Exception $e) {
            return redirect()->route('fund-disbursement-1.index')->with('error', 'Failed to update transfer receipt: ' . $e->getMessage());
        }
    }
